...
namespace GameStore_WEB
{
    public partial class MLModelGameReview
    {
        public const string RetrainFilePath =  @"C:\Users\User\source\repos\MineLisovich\GameStore_Remastering\GameStore.WEB\wwwroot\FilesStorage\gameReviews.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.034811728F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
